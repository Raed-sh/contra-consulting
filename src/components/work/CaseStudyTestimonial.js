    ...
    <section className="py-16 overflow-hidden bg-white sm:py-20 lg:py-28">
      <Container>
        <div className="max-w-6xl mx-auto">
          <h2 className="max-w-3xl mx-auto text-4xl font-semibold leading-tight text-center font-display text-[#00215E] sm:text-5xl sm:leading-tight">
          ...
          <div className="relative w-full max-w-4xl px-6 py-10 mx-auto overflow-hidden mt-14 rounded-3xl bg-slate-50 sm:mt-16 sm:p-12 md:px-16 md:py-14 lg:mt-20 lg:px-20 lg:py-16">
            ...
            <blockquote className="relative">
              ...
              <p className="relative text-lg font-medium leading-8 text-[#00215E] sm:text-xl sm:leading-10">
                &quot;{testimonial.text}&quot;
              </p>
            </blockquote>
            <div className="relative">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center w-auto gap-5">
                  ...
                  <div>
                    <p className="text-base font-medium font-display text-[#00215E]">

...
function Tag({ tag }) {
  ...
  return (
    <li>
      <Link
        href={href}
        className="inline-block px-6 py-2 text-sm font-medium transition duration-200 ease-in-out rounded-full bg-slate-50 text-slate-800 ring-1 ring-slate-100/80 hover:bg-slate-100/95 hover:text-[#00215E] lg:text-md"
      >
        {tag}
      </Link>
    </li>
    ...
    <section className="pt-16 overflow-hidden bg-white sm:pt-20 lg:pt-28">
      <Container>
        <div className="max-w-lg mx-auto sm:max-w-3xl lg:mx-0 lg:max-w-none">
          <h1 className="text-4xl font-semibold leading-tight font-display text-[#00215E] sm:text-5xl sm:leading-tight lg:text-6xl lg:leading-tight">
            {title} - {subtitle}
          </h1>

                ...
                <div className="flex gap-[18px]">
                  ...
                  <div className="sm:pt-0.5">
                    <p className="font-display text-lg text-primary">
                      {t('contactPage.contactDetails.email.title')}
                    </p>
                    <p className="mt-1.5 text-base text-slate-600 sm:mt-2">
                      {t('contactPage.contactDetails.email.description')}
                    </p>
                    <Link
                ...
                <div className="flex gap-[18px]">
                  ...
                  <div className="sm:pt-0.5">
                    <p className="font-display text-lg text-[#00215E]">
                      {t('contactPage.contactDetails.phone.title')}
                    </p>
                    <p className="mt-2 text-base text-slate-600">
                      {t('contactPage.contactDetails.phone.description')}
                    </p>
                    <Link
